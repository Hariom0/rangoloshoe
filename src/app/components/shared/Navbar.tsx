...
export function WhatsAppIcon({ className }: { className?: string }) {
	return (
		<svg viewBox="0 0 32 32" fill="currentColor" className={className}>
			<path d="M19.11 17.34c-.28-.14-1.65-.81-1.91-.9-.25-.09-.43-.14-.62.14-.18.28-.71.9-.87 1.08-.16.19-.31.21-.59.07-.28-.14-1.17-.43-2.23-1.38-.82-.73-1.38-1.63-1.54-1.91-.16-.28-.02-.43.12-.57.13-.13.28-.33.43-.49.14-.17.19-.28.28-.47.09-.19.05-.35-.02-.49-.07-.14-.62-1.49-.85-2.04-.22-.52-.45-.45-.62-.46h-.53c-.19 0-.49.07-.75.35-.25.28-.97.95-.97 2.32 0 1.37.99 2.7 1.13 2.89.14.19 1.95 2.98 4.73 4.18.66.29 1.18.46 1.58.59.66.21 1.26.18 1.73.11.53-.08 1.65-.67 1.88-1.32.23-.66.23-1.22.16-1.33-.07-.11-.25-.18-.53-.33z" />
			<path d="M16.01 3C8.83 3 3 8.83 3 16c0 2.53.74 4.99 2.14 7.1L3.5 29l5.99-1.57A13 13 0 1 0 16.01 3zm0 23.62c-2.15 0-4.25-.58-6.09-1.68l-.44-.26-3.55.93.95-3.46-.29-.46A10.57 10.57 0 1 1 16.01 26.62z" />
		</svg>
	);
}

		...
		<section className="overflow-hidden ">
			<div className="flex  flex-col md:flex-row">
				...
				<div className="flex w-full flex-col justify-center px-6  sm:px-10 md:w-1/2 md:px-16 lg:px-20">
					...
					{/* Heading */}
					<h1 className="mb-8 text-5xl leading-[1.05] tracking-tight text-foreground sm:text-6xl lg:text-7xl">
					...
					<div className="flex flex-wrap items-center gap-4">
						...
						{/* Secondary CTA */}
						<Link href="#" className="group flex items-center gap-1.5 text-sm font-medium text-foreground/70 transition-colors duration-300 hover:text-primary">
							Learn More
